...
import com.distcomp.utils.LoggingTestUtils.{getInitiatorCounts, getInitiatorCountsElection, verifyElectionLeader}
...
class EchoElectionTest extends AnyWordSpecLike {
  ...
  val mutexTestFile: String = getClass.getResource("/election/EchoElectionPlan.json").getPath
